...
import edu.neu.coe.info6205.union_find.UFClient;
import edu.neu.coe.info6205.union_find.WeighedUnionFindWithPathCompressionAllNodes;
	...
	public static void main(String args[]) {
		...
		Random random = new Random();
			...
			for (int i = 0; i < 8; i++) {
				...
				System.out.println("No of Sites: " + n + " takes mean time of: " + mean);
			         n = n * 2;
			}
