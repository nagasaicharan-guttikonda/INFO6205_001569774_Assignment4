 ...
 */
public class WeighedUnionFindWithPathCompressionAllNodes implements UF {
    /**
     ...
     */
    public WeighedUnionFindWithPathCompressionAllNodes(int n, boolean pathCompression) {
        count = n;
        parent = new int[n];
        height = new int[n];
        for (int i = 0; i < n; i++) {
     ...
     * @throws IllegalArgumentException if {@code n < 0}
     */
    public WeighedUnionFindWithPathCompressionAllNodes(int n) {
        this(n, true);
    }
