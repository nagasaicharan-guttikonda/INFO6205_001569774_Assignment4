...
/**
 * depth-weighted Quick Union with Path Compression
 */
public class UnionByDepthUF implements UF {
    /**
    ...
    private void mergeComponents(int i, int j) {
    	...
    	if (depth[rootI] >= depth[rootJ]) 
		 {
    		if(depth[rootI] == depth[rootJ])  depth[rootI] = depth[rootI] + 1;
    		else  depth[rootI] = depth[rootI];
	     parent[rootJ] = rootI;
	     }
